...
const steps = [
  {
    ...
    description:
      "Tell us about your case, the expertise you need, and your timeline. We'll take it from there.",
  },
  {
    number: '02',
    title: 'Review Matched Experts',
    description:
      'We identify the most qualified experts from our network. Review their credentials, experience, and prior testimony history.',
  },
  {
    number: '03',
    title: 'We Handle the Engagement',
    description:
      'Contracts, scheduling, fee agreements, compliance, coordination: we take care of it all.',
  },
  {
    number: '04',
    title: 'Expert Delivers Results',
    description:
      'Your expert delivers reports, depositions, and courtroom testimony.',
  },
]
