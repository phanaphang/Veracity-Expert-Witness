  ...
  return (
    <div className="legal-page">
      <SEO
        ...
        serviceSchema={{
          serviceType: 'Accident Reconstruction Expert Witness Services',
        }}
      />
      ...
      <header className="legal-header">
        <div className="section__container">
          ...
          <p className="legal-header__subtitle">
            We connect you with accident reconstruction specialists who use
            science and engineering to determine how and why incidents occurred.
          </p>
        </div>
      </header>
      ...
      <main className="legal-content specialty-content">
        <p className="specialty-intro">
          Accident reconstruction cases require expert witnesses who combine
          engineering principles, physics, and investigative techniques to
          establish the facts of an incident. Our network includes certified
          accident reconstructionists, biomechanical engineers, vehicle systems
          experts, and highway safety specialists.
        </p>
