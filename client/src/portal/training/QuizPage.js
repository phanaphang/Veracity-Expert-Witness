    ...
    <div className="training-quiz">
      <div className="portal-page__header">
        ...
        <p className="portal-page__subtitle">
          3 questions · Pass score: 2 out of 3
        </p>
      </div>
      ...
      {alreadyPassed && !submitted && (
        ...
        >
          ...
          or{' '}
          {nextLesson ? (
            <Link to={`/training/lesson/${nextLesson}`}>
      ...
      {outOfRetries && (
        <div className="training-quiz__result training-quiz__result--fail">
          ...
          <div className="training-quiz__result-actions">
            <Link
              to={`/training/lesson/${unit.lessons[0]}`}
              className="btn btn--primary"
            >
              Review Unit Lessons
            </Link>
          ...
          {quiz.questions.map((q, qi) => {
            ...
            return (
              ...
              >
                ...
                {submitted && (
                  <div
                    className={`training-quiz__explanation${isCorrect ? ' training-quiz__explanation--correct' : ' training-quiz__explanation--wrong'}`}
                  >
                    <strong>
                      {isCorrect
                        ? 'Correct.'
