...
const MODULE_TITLE = 'Deposition as an Expert Witness';

export default function DepositionCertificatePage({ onProgressUpdate }) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      pdf.save('deposition-certificate.pdf');
    } catch (e) {
              ...
              <div className="training-certificate__frame">
                ...
                <div className="training-certificate__footer">
                  ...
                  <p className="training-certificate__footer-text">
                    This certificate confirms the recipient has successfully completed the Deposition
                    as an Expert Witness training module, including all lessons, branching scenario,
                    and knowledge check.
                  </p>
                </div>
              </div>
