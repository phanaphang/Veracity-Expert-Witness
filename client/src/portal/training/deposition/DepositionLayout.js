...
import DepositionSidebar from './DepositionSidebar';

export default function DepositionLayout({ children }) {
  ...
  const loadProgress = useCallback(async () => {
    ...
    try {
      ...
      console.error('DepositionLayout: failed to load progress', e);
    }
  }, [user]);
    ...
    <div className="training-layout">
      ...
      <main className="training-main">
        ...
        <header className="portal-topbar">
          ...
          <span className="portal-topbar__title">Deposition</span>
        </header>
