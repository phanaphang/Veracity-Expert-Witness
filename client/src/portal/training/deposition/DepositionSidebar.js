...
import { LESSON_SEQUENCE } from './depositionData';
...
export default function DepositionSidebar({
  completedLessons,
  scenarioComplete,
  quizPassed,
  onNavigate,
  ...
  const activeLesson = (id) => location.pathname === `/training/deposition/lesson/${id}`;
  const activeScenario = location.pathname === '/training/deposition/scenario';
  const activeQuiz = location.pathname === '/training/deposition/quiz';
  const activeCert = location.pathname === '/training/deposition/certificate';
    ...
    <nav className="training-sidebar" aria-label="Course navigation">
      ...
      >
        ...
        <div>
          ...
          <div className="training-sidebar__brand-sub">Deposition</div>
        </div>
      </Link>
      ...
      <div className="training-sidebar__nav">
        ...
        <div className="training-sidebar__unit">
          ...
          {!scenarioUnlocked ? (
            <div className="training-sidebar__lesson training-sidebar__lesson--locked">
              <LockIcon />
              <span>The Expert Under Fire</span>
            </div>
          ) : (
            <Link
        ...
        <div className="training-sidebar__unit">
          <Link
            ...
            className={`training-sidebar__lesson${location.pathname === '/training/deposition/resources' ? ' training-sidebar__lesson--active' : ''}`}
            onClick={onNavigate}
          >
            <span className="training-sidebar__dot" />
