...
export default function DepositionDashboard() {
  ...
  function getNextAction() {
    ...
    if (!scenarioComplete) {
      return {
        label: 'Start Branching Scenario: The Expert Under Fire',
    ...
    if (!certificateIssued) {
      return {
        ...
        to: '/training/deposition/certificate',
      }
    }
    return {
    ...
    <div>
      <div className="portal-page__header">
        ...
        <p className="portal-page__subtitle">
          ...
          Complete all 8 lessons, the branching scenario, and the knowledge
      ...
      <div className="portal-card training-progress-card">
        ...
        <div className="training-progress-card__meta">
          {completedSteps} of {TOTAL_STEPS} steps complete &middot; ~60 min
          total
        </div>
        {!loading && (
          <Link
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              >
                Apply your knowledge to a real-world deposition challenge -- the
                learned treatise ambush and scope creep question, with immediate
                feedback and practical takeaways.
              </p>
              {accessible && (
                <Link
                  to="/training/deposition/scenario"
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              <div className="training-unit-card__meta">
                ~5 min &middot; Pass score: 6 out of 8
              </div>
              <p
                style={{
                  color: 'var(--color-gray-500)',
              ...
              >
                Covers all eight lessons -- deposition purpose, preparation,
                answering technique, learned treatises, scope of engagement,
                transcript review, and composure. Two retries allowed.
              </p>
              {accessible && (
                <Link
        ...
        <div className="training-resources-card__body">
          <div>
            ...
            <p className="training-resources-card__sub">
              4 reference guides -- quick reference, checklists, preparation
              guides, and module summary
            </p>
          </div>
          <Link
