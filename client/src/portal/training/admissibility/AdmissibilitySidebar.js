...
export default function AdmissibilitySidebar({
  ...
  const activeLesson = (id) => location.pathname === `/training/admissibility/lesson/${id}`;
  const activeScenario = location.pathname === '/training/admissibility/scenario';
    ...
    <nav className="training-sidebar" aria-label="Course navigation">
      ...
      >
        ...
        <div>
          ...
          <div className="training-sidebar__brand-sub">Standards of Admissibility</div>
        </div>
      </Link>
