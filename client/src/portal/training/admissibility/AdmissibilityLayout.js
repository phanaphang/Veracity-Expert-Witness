...
import AdmissibilitySidebar from './AdmissibilitySidebar';
...
export default function AdmissibilityLayout({ children }) {
  ...
  const loadProgress = useCallback(async () => {
    ...
    try {
      ...
      setQuizPassed((quizRow?.quiz_score?.score ?? 0) >= 4);
    } catch (e) {
      console.error('AdmissibilityLayout: failed to load progress', e);
    }
  }, [user]);
    ...
    <div className="training-layout">
      ...
      <main className="training-main">
        ...
        <header className="portal-topbar">
          ...
          <span className="portal-topbar__title">Standards of Admissibility</span>
        </header>
