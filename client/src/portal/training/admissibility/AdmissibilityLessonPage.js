...
// Renders the rich content sections defined in admissibilityData.js
...
export default function AdmissibilityLessonPage({ onProgressUpdate }) {
  ...
  if (!lesson) {
    return (
      <div>
        ...
        <Link to="/training/admissibility" className="btn btn--secondary" style={{ marginTop: 16 }}>
          Back to Training
        </Link>
      </div>
    );
      ...
      <div className="training-lesson__footer">
        ...
        {alreadyCompleted ? (
          <div className="training-lesson__already-done">
            ...
            {nextLessonId && (
              <Link
                to={`/training/admissibility/lesson/${nextLessonId}`}
