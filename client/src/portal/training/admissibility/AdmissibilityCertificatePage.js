...
export default function AdmissibilityCertificatePage({ onProgressUpdate }) {
    ...
    try {
      ...
      if (!emailSent) {
        ...
        if (token && profile?.email) {
          try {
            await fetch('/api/training/admissibility-certificate-issued', {
              method: 'POST',
              headers: {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      pdf.save('admissibility-standards-certificate.pdf');
    } catch (e) {
              ...
              <div className="training-certificate__frame">
                ...
                <div className="training-certificate__details">
                  ...
                  <div className="training-certificate__detail-row">
                    ...
                    <span className="training-certificate__detail-value">
                      Veracity Expert Witness · California
                    </span>
                  </div>
                </div>
                ...
                <div className="training-certificate__footer">
                  ...
                  <p className="training-certificate__footer-text">
                    This certificate confirms the recipient has successfully completed the Standards
                    of Admissibility: Frye, Kelly, and Daubert training module, including all
                    lessons, branching scenario, and knowledge check.
                  </p>
                </div>
              </div>
            </div>
