...
export default function AdmissibilityDashboard() {
  ...
  function getNextAction() {
    ...
    if (!scenarioComplete) {
      return {
        label: 'Start Branching Scenario: The Challenge',
    ...
    <div>
      <div className="portal-page__header">
        <h1 className="portal-page__title">
          Standards of Admissibility: Frye, Kelly, and Daubert
        </h1>
        <p className="portal-page__subtitle">
          Welcome{profile?.first_name ? `, ${profile.first_name}` : ''}.
          Complete all 3 lessons, the branching scenario, and the knowledge
      ...
      <div className="portal-card training-progress-card">
        ...
        <div className="training-progress-card__meta">
          {completedSteps} of {TOTAL_STEPS} steps complete &middot; ~30 min
          total
        </div>
        {!loading && (
          <Link
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              >
                Apply your knowledge to a real-world admissibility challenge -
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              <div className="training-unit-card__meta">
                ~5 min &middot; Pass score: 4 out of 5
              </div>
              <p
                style={{
                  color: 'var(--color-gray-500)',
              ...
              >
                Covers all three lessons - jurisdiction, Kelly, Daubert, and
                multi-industry application. Two retries allowed.
              </p>
              {accessible && (
                <Link
                  to="/training/admissibility/quiz"
        ...
        <div className="training-resources-card__body">
          <div>
            ...
            <p className="training-resources-card__sub">
              5 reference guides - quick reference, checklists, preparation
              guides, state-by-state standards, and module summary
            </p>
          </div>
          <Link
