    ...
    if (isPassing || attempts >= 2) {
      ...
      try {
        ...
        if (isPassing) {
          ...
          if (missed === 0) {
            setTimeout(() => navigate('/training/report-writing/certificate'), 1800);
          }
        }
      } catch (e) {
    ...
    <div className="training-quiz">
      ...
      {alreadyPassed && !submitted && (
        <div className="portal-alert portal-alert--success" style={{ marginBottom: 24 }}>
          ...
          <Link to="/training/report-writing/certificate">go to your certificate →</Link>
        </div>
      )}
      ...
      {passed && (
        <div className="training-quiz__result training-quiz__result--pass">
          ...
          <div className="training-quiz__result-actions">
            <Link to="/training/report-writing/certificate" className="btn btn--primary">
      ...
      {outOfRetries && (
        <div className="training-quiz__result training-quiz__result--fail">
          ...
          <div className="training-quiz__result-actions">
            <Link to="/training/report-writing/lesson/1" className="btn btn--primary">
              Review Lessons
            </Link>
            <Link to="/training/report-writing" className="btn btn--secondary">
              Back to Dashboard
