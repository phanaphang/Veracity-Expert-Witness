...
import { SCENARIO_DATA } from './reportWritingData';

export default function ReportWritingScenarioPage({ onProgressUpdate }) {
        ...
        <div className="portal-card" style={{ marginTop: 24 }}>
          ...
          <div className="training-scenario__footer" style={{ marginTop: 28 }}>
            <button
              ...
              onClick={() => navigate('/training/report-writing/quiz')}
            >
