...
const MODULE_TITLE = 'Writing an Expert Witness Testimony Report';

export default function ReportWritingCertificatePage({ onProgressUpdate }) {
    ...
    try {
      ...
      if (!emailSent) {
        ...
        if (token && profile?.email) {
          try {
            await fetch('/api/training/report-writing-certificate-issued', {
              method: 'POST',
              headers: {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      pdf.save('report-writing-certificate.pdf');
    } catch (e) {
              ...
              <div className="training-certificate__frame">
                ...
                <div className="training-certificate__details">
                  ...
                  <div className="training-certificate__detail-row">
                    ...
                    <span className="training-certificate__detail-value">
                      ~60 minutes &middot; 8 Lessons &middot; 1 Scenario &middot; 1 Knowledge Check
                    </span>
                  </div>
                  <div className="training-certificate__detail-row">
                ...
                <div className="training-certificate__footer">
                  ...
                  <p className="training-certificate__footer-text">
                    This certificate confirms the recipient has successfully completed the Writing
                    an Expert Witness Testimony Report training module, including all lessons,
                    branching scenario, and knowledge check.
                  </p>
                </div>
              </div>
            </div>
