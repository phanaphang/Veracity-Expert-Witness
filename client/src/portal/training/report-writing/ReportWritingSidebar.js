...
export default function ReportWritingSidebar({
  ...
  const activeLesson = (id) =>
    location.pathname === `/training/report-writing/lesson/${id}`
  const activeScenario =
    location.pathname === '/training/report-writing/scenario'
  const activeQuiz = location.pathname === '/training/report-writing/quiz'
  const activeCert =
    location.pathname === '/training/report-writing/certificate'
