...
import { LESSON_SEQUENCE } from './reportWritingData';
...
export default function ReportWritingSidebar({
  completedLessons,
  scenarioComplete,
  quizPassed,
  onNavigate,
  ...
  const activeLesson = (id) => location.pathname === `/training/report-writing/lesson/${id}`;
  const activeScenario = location.pathname === '/training/report-writing/scenario';
  const activeQuiz = location.pathname === '/training/report-writing/quiz';
  const activeCert = location.pathname === '/training/report-writing/certificate';
    ...
    <nav className="training-sidebar" aria-label="Course navigation">
      ...
      >
        ...
        <div>
          ...
          <div className="training-sidebar__brand-sub">Report Writing</div>
        </div>
      </Link>
      ...
      <div className="training-sidebar__nav">
        ...
        <div className="training-sidebar__unit">
          <Link
            ...
            className={`training-sidebar__lesson${location.pathname === '/training/report-writing/resources' ? ' training-sidebar__lesson--active' : ''}`}
            onClick={onNavigate}
          >
            <span className="training-sidebar__dot" />
