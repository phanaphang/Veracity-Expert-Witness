...
export default function ReportWritingDashboard() {
  ...
  function getNextAction() {
    ...
    if (!scenarioComplete) {
      return {
        label: 'Start Branching Scenario: The Draft Review',
    ...
    if (!certificateIssued) {
      return {
        ...
        to: '/training/report-writing/certificate',
      }
    }
    return {
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              >
                Apply your knowledge to a real-world report review challenge -
                two decision points, immediate feedback, and practical
                takeaways.
              </p>
              {accessible && (
                <Link
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              >
                Covers all eight lessons - report structure, opinion writing,
                materials reviewed, methodology, deposition defense, formatting,
                and common pitfalls. Two retries allowed.
              </p>
              {accessible && (
                <Link
                  to="/training/report-writing/quiz"
