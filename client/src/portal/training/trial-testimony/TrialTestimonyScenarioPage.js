...
import { SCENARIO_DATA } from './trialTestimonyData';

export default function TrialTestimonyScenarioPage({ onProgressUpdate }) {
        ...
        <div className="portal-card" style={{ marginTop: 24 }}>
          ...
          <div className="training-scenario__footer" style={{ marginTop: 28 }}>
            <button
              ...
              onClick={() => navigate('/training/trial-testimony/quiz')}
            >
              Continue to Knowledge Check &rarr;
            </button>
          </div>
        </div>
      )}
