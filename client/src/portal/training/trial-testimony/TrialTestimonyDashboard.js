...
export default function TrialTestimonyDashboard() {
  ...
  function getNextAction() {
    ...
    if (!scenarioComplete) {
      return { label: 'Start Branching Scenario: The Unexpected Objection', to: '/training/trial-testimony/scenario' };
    }
    if (!quizPassed) {
      return { label: 'Take Knowledge Check', to: '/training/trial-testimony/quiz' };
    }
    if (!certificateIssued) {
      return { label: 'Get Your Certificate', to: '/training/trial-testimony/certificate' };
    }
    return { label: 'View Your Certificate', to: '/training/trial-testimony/certificate' };
  }
  ...
  return (
    <div>
      <div className="portal-page__header">
        <h1 className="portal-page__title">Trial Testimony as an Expert Witness</h1>
        <p className="portal-page__subtitle">
          Welcome{profile?.first_name ? `, ${profile.first_name}` : ''}. Complete all 10 lessons,
      ...
      <div className="portal-card training-progress-card">
        ...
        <div className="training-progress-card__meta">
          {completedSteps} of {TOTAL_STEPS} steps complete &middot; ~75 min total
        </div>
        {!loading && (
            ...
            >
              <div className="training-unit-card__header">
                <div>
                  ...
                  <h2 className="training-unit-card__title">The Unexpected Objection</h2>
                </div>
                {scenarioComplete && (
                  <span className="portal-badge portal-badge--approved">Complete</span>
                )}
              ...
              <p style={{ color: 'var(--color-gray-500)', fontSize: 14, margin: '8px 0 16px' }}>
                Navigate a sustained objection and a follow-up cross-examination attack on your
                excluded evidence, with immediate feedback and practical takeaways.
              </p>
              {accessible && (
                <Link
            ...
            >
              <div className="training-unit-card__header">
                <div>
                  ...
                  <h2 className="training-unit-card__title">10-Question Quiz</h2>
                </div>
                {quizPassed && (
              ...
              <div className="training-unit-card__meta">~5 min &middot; Pass score: 8 out of 10</div>
              <p style={{ color: 'var(--color-gray-500)', fontSize: 14, margin: '8px 0 16px' }}>
        ...
        <div className="training-resources-card__body">
          <div>
            ...
            <p className="training-resources-card__sub">
              4 reference guides -- trial preparation checklist, cross-examination survival guide,
              jury communication tips, and full module summary
            </p>
          </div>
