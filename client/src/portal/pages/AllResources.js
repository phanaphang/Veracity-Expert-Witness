...
const MODULES = [
  {
    ...
    description:
      '5 reference guides covering CV preparation, deposition prep, California rules, fee disclosure, and a full lesson summary.',
  ...
  },
  {
    ...
    description:
      '5 reference guides covering Frye vs. Kelly vs. Daubert, California admissibility checklists, federal Daubert preparation, state-by-state standards, and a full module summary.',
  ...
  },
  {
    ...
    description:
      '4 reference guides covering report structure, opinion writing, methodology & deposition defense, and a full module summary.',
  ...
  },
  {
    title: 'Deposition',
    description:
      '4 reference guides covering deposition preparation, answering techniques, common traps & counter-strategies, and a full module summary.',
  ...
  },
  {
    ...
    description:
      '4 reference guides covering trial preparation, cross-examination survival, jury communication tips, and a full module summary.',
    ...
    <div>
      <div className="portal-page__header">
        ...
        <p className="portal-page__subtitle">
          {MODULES.reduce((sum, m) => sum + m.count, 0)} downloadable reference
          guides across {MODULES.length} training modules
        </p>
      </div>
