        ...
        <form onSubmit={handleSubmit}>
          <div className="portal-field">
            ...
            <input
              ...
              required
              placeholder="e.g. Medical Malpractice — Smith v. Hospital"
            />
          </div>
          <div className="portal-field">
            ...
            <textarea
              ...
              required
              rows="4"
              placeholder="Describe the case details and what type of expert is needed..."
            />
          </div>
          <div className="portal-field">
            ...
            {hasSubs ? (
              ...
              >
                ...
                {selectedSpecialties.length > 0 && (
                  ...
                  >
                    {selectedSpecialties.length} subspecialt
              ...
              <select
                ...
                onChange={(e) =>
                  setSelectedSpecialties(e.target.value ? [e.target.value] : [])
                }
              >
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setForm((prev) => ({
                    ...prev,
                    case_manager: managerConfirmTarget.id,
                  }))
